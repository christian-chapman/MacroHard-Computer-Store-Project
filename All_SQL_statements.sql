...
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (1, 1, 'Filbert', 'Killingworth', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (2, 2, 'Darsey', 'Frosch', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (3, 3, 'Tracy', 'Brunone', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (4, 4, 'Cross', 'Furzer', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (5, 5, 'Alvy', 'Essery', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (6, 6, 'Dukey', 'Castro', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (7, 7, 'Jacobo', 'Kamena', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (8, 8, 'Sherri', 'Conradie', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (9, 9, 'Valenka', 'Brownill', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (10, 10, 'Mauricio', 'Andreaccio', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (11, 11, 'Clarance', 'Leil', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (12, 12, 'Lynnea', 'Sturmey', 'Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (13, 11, 'Gay', 'Symmons', 'Security');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (14, 2, 'Rozalin', 'Sautter', 'Project Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (15, 4, 'Nan', 'Eveling', 'Cashier');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (16, 4, 'Myriam', 'Gammett', 'Cashier');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (17, 4, 'Innis', 'Zammitt', 'Cashier');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (18, 3, 'Cecilla', 'Dreus', 'Accountant');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (19, 5, 'Aaren', 'Lukianovich', 'Shipping Manager');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (20, 4, 'Boyce', 'Flitcroft', 'Cashier');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (21, 7, 'Fremont', 'Dan', 'Tech Support');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (22, 6, 'Laina', 'Ellison', 'Human Resources');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (23, 9, 'Margaretta', 'Arni', 'Marketer');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (24, 10, 'Darcee', 'Woliter', 'IT');
insert into employee (emp_id, department_id, first_name, last_name, emp_role) values (25, 3, 'Norby', 'Wyllis', 'Janitor');
